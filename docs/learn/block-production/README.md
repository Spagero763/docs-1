...
{% step %}
**Signing**
Signing is the process used to validate and append blocks, execute tenure-change transactions, and sign sBTC deposits and withdrawals. Stackers participate in signing once they meet stacking prerequisites.
{% endstep %}
{% endstepper %}
There are two primary parties in Stacks block production: miners and stackers. Miners decide block contents by building and proposing new blocks, while stackers decide block inclusion by validating those blocks, executing tenure changes, and signing sBTC deposits and withdrawals. Stacking enables stackers to participate in signing.
